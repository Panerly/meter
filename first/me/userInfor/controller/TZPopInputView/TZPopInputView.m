...
#define mBlueColor [UIColor colorWithRed:227.0/255.0 green:131.0/255.0 blue:21.0/255.0 alpha:1.0]
...
- (void)checkTextFieldText {
    ...
    [self.okButton setTitle:@"确认" forState:UIControlStateDisabled];
