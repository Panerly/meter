...
@property (nonatomic, assign) UIFont  *descriptionTextFont;

/** Default is white. */
@property (nonatomic, assign) UIColor *descriptionTextColor;

/** Default is black, with an alpha of 0.4. */
@property (nonatomic, assign) UIColor *descriptionTextShadowColor;
