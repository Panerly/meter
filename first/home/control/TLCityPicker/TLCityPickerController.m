...
- (UISearchController *) searchController
{
    if (_searchController == nil) {
        ...
        [_searchController.searchBar setBarTintColor:[UIColor colorWithWhite:0.95 alpha:0.01]];
        [_searchController.searchBar sizeToFit];
        [_searchController setSearchResultsUpdater:self.searchResultVC];
        [_searchController.searchBar.layer setBorderWidth:0.5f];
        [_searchController.searchBar.layer setBorderColor:[UIColor colorWithWhite:0.7 alpha:0.01].CGColor];
    }
