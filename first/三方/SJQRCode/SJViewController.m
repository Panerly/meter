...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([self isCameraIsAuthorized]) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"相机权限提示" message:kIsAuthorizedString preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *cancelBtn = [UIAlertAction actionWithTitle:@"知道了" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
